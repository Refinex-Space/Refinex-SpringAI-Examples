...
public class HttpClientCaller {
    ...
    private static final String API_KEY = System.getenv("DASHSCOPE_KEY");
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        if (API_KEY == null || API_KEY.isBlank()) {
            logger.severe("错误：未设置环境变量 DASHSCOPE_KEY");
            logger.info("请通过以下方式设置：");
            logger.info("  Linux/Mac: export DASHSCOPE_KEY=your_api_key");
            logger.info("  Windows:   set DASHSCOPE_KEY=your_api_key");
            System.exit(1);
        }
